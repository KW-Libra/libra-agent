    ...
    def test_kis_config_loader_reads_flat_yaml(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            config_path.write_text(
                "\n".join(
                    [
                        'my_app: "fixture-real-app"',
                        'my_sec: "fixture-real-value"',
                        'paper_app: "fixture-paper-app"',
                        'paper_sec: "fixture-paper-value"',
            ...
            self.assertEqual(config.app_key, "fixture-real-app")
            self.assertEqual(config.app_secret, "fixture-real-value")
    ...
    def test_kis_client_builds_portfolio_snapshot(self) -> None:
        ...
        with httpx.Client(transport=transport, base_url="https://test.example") as http_client:
            args = argparse.Namespace(
                ...
                kis_app_secret="fixture-app-value",
