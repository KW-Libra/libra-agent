...
class AnthropicChatClient:
    ...
    def ensure_available(self) -> None:
        ...
        try:
            ...
            raise AnthropicClientError(f"Anthropic API is not reachable at {self.base_url}: {exc}") from exc
            ...
            if char == "{":
                ...
                if depth == 0:
                    ...
                    try:
                        ...
                        raise AnthropicClientError(f"Failed to parse Anthropic JSON chunk: {exc}") from exc
                    if not isinstance(payload, Mapping):
