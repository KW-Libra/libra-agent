...
def build_domain_agent_adapters() -> dict[str, JyDomainAgentAdapter]:
    ...
    return {
        ...
        "compliance": JyDomainAgentAdapter(ComplianceAgent(), agent_id="compliance", owner_scope="Compliance Agent (Clarke)"),
        "macro": JyDomainAgentAdapter(MacroAgent(), agent_id="macro", owner_scope="Macro Agent (Halden)"),
        "sentiment": JyDomainAgentAdapter(SentimentAgent(), agent_id="sentiment", owner_scope="Sentiment Agent (Imo)"),
        "execution": JyDomainAgentAdapter(ExecutionAgent(), agent_id="execution", owner_scope="Execution Agent (Tien)"),
