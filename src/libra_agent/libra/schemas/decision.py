...
class DecisionBranch(StrEnum):
    ...
    NO_EXECUTABLE_TRADE = "NO_EXECUTABLE_TRADE"
    HOLD = "HOLD"
...
class ConsensusScore:
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "vote_distribution": {
                key.value: value for key, value in self.vote_distribution.items()
            },
...
class FinalDecision:
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "user_options": [option.to_dict() for option in self.user_options]
