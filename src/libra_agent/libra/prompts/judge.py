...
JUDGE_PHASE_SYSTEM_PROMPT = (
    ...
    "On a calm pull check with no meaningful supplied signal and no trade draft, prefer HOLD over DEFER, except when holdings and candidate_rebalance_plan are both empty. "
    "If holdings and candidate_rebalance_plan are both empty, decision must be DEFER. "
