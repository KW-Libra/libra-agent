...
def infer_signal_profile(
    *,
    ...
    event_type = normalize_event_type(explicit_event_type) or _find_first_text(evidence or {}, ("event_type", "dominant_event_type"))
    event_type = normalize_event_type(event_type)
    horizon = normalize_horizon(explicit_horizon) or _find_first_text(evidence or {}, ("horizon", "time_horizon"))
